...
<title>Saskia Rental | Dashboard</title>
<!--Bootstrap -->
...
<link rel="shortcut icon" href="assets/images/favicon-icon/logosaskia.png">
      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1>Kenyamanan Berkendara Dirasakan Dengan Mobil Yang Tepat.</h1>
            <p>Referensi Mobil Menarik Untuk Anda </p>
